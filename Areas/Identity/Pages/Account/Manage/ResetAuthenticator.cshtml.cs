...
// ATUA COMO MODELO E "CONTROLADOR" (PÁGINA) QUANDO SE TRATA DE REINICIAR AUTENTICADOR
...
namespace WebRPGCreation.Areas.Identity.Pages.Account.Manage
{
    ...
    public class ResetAuthenticatorModel : PageModel
    {
        ...
        // MÉTODO ASSÍNCRONO PARA REINICIAR AUTENTICADOR (GET)
        ...
        // MÉTODO ASSÍNCRONO PARA REINICIAR AUTENTICADOR (POST)
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "A chave da sua aplicação autenticadora foi redefinida, você precisará configurar sua aplicação autenticadora usando uma nova chave.";
