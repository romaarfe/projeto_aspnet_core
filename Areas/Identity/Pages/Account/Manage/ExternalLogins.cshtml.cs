...
// ATUA COMO MODELO E "CONTROLADOR" (PÁGINA) QUANDO SE TRATA DE LOGINS EXTERNOS (SEM USO EFETIVO)
...
namespace WebRPGCreation.Areas.Identity.Pages.Account.Manage
{
    ...
    public class ExternalLoginsModel : PageModel
    {
        ...
        // MÉTODO ASSÍNCRONO PARA LOGINS EXTERNOS (GET)
        ...
        // MÉTODO ASSÍNCRONO PARA LOGINS EXTERNOS (POST - REMOVER)
        ...
        // MÉTODO ASSÍNCRONO PARA LOGINS EXTERNOS (POST - CONECTAR)

        public async Task<IActionResult> OnPostLinkLoginAsync(string provider)
        {
            // LIMPA COOKIES EXTERNOS PARA ASSEGURAR UM PROCESSO LIMPO DE LOGIN EXTERNO

            await HttpContext.SignOutAsync(IdentityConstants.ExternalScheme);

            // REQUISITA REDIRECIONAMENTO AO LOGIN EXTERNO E CONECTA O MESMO AO UTILIZADOR ATUAL
        ...
        // MÉTODO ASSÍNCRONO PARA LOGINS EXTERNOS (GET - CALLBACK)
