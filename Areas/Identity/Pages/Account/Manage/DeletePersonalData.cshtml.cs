...
// ATUA COMO MODELO E "CONTROLADOR" (PÁGINA) QUANDO SE TRATA DE DELETAR DADOS PESSOAIS
...
namespace WebRPGCreation.Areas.Identity.Pages.Account.Manage
{
    ...
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "A Senha é um campo necessário.")]
        ...
        // MÉTODO ASSÍNCRONO PARA DELETAR DADOS PESSOAIS (GET)
        ...
        // MÉTODO ASSÍNCRONO PARA DELETAR DADOS PESSOAIS (POST)
