...
// ATUA COMO MODELO E "CONTROLADOR" (PÁGINA) QUANDO SE TRATA DE GERENCIAMENTO DE PERFIL
...
namespace WebRPGCreation.Areas.Identity.Pages.Account.Manage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        // MÉTODO ASSÍNCRONO PARA GERENCIAMENTO DE PERFIL (LOAD)
        ...
        // MÉTODO ASSÍNCRONO PARA GERENCIAMENTO DE PERFIL (GET)
        ...
        // MÉTODO ASSÍNCRONO PARA GERENCIAMENTO DE PERFIL (POST)
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                {
                    StatusMessage = "Erro inesperado ao tentar definir o telefone.";
