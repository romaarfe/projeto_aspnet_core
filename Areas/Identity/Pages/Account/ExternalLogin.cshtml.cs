...
// ATUA COMO MODELO E "CONTROLADOR" (PÁGINA) QUANDO SE TRATA DE LOGINS EXTERNOS (SEM UTILIZAÇÃO)
...
namespace WebRPGCreation.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        // MÉTODO ASSÍNCRONO PARA INSERIR SENHAS (CALLBACK)
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            // AUTENTICA O UTILIZADOR COM LOGIN EXTERNO SE JÁ TIVER UM LOGIN.
            ...
            else
            {
                ...
                // SE O UTILIZADOR NÃO POSSUI UMA CONTA, ENTÃO PEDE AO UTILIZADOR QUE CRIE UMA CONTA.
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        // SE A CONFIRMAÇÃO FOI REQUERIMENTO, É NECESSÁRIO APRESENTAR UM LINK CASO NÃO ESTEJA CONFIRGURA UM EMAIL SENDER REAL
        ...
        // MÉTODO PARA CRIAÇÃO DO UTILIZADOR
        ...
        // MÉTODO PARA BUSCAR EMAIL GUARDADO
